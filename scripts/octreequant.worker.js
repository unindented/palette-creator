var Cube, MAX_NODES, MAX_RGB, MAX_TREE_DEPTH, Node, OctreeQuant, QUICK, SHIFT, SQUARES, Search, _ref, _result, log, onmessage, x;
onmessage = function(e) {
  var data, palette, quant;
  data = e.data;
...
OctreeQuant.prototype.quantizeImage = function(pixels, max_colors) {
  var _ref2, color, colormap, cube, i, palette;
...
Cube.prototype.classification = function() {
  var _ref2, _ref3, blue, green, i, id, l, len, level, node, red;
  len = Math.floor(this.pixels.length / 4);
  _ref2 = len - 1;
  for (l = 0; (0 <= _ref2 ? l <= _ref2 : l >= _ref2); (0 <= _ref2 ? l += 1 : l -= 1)) {
    i = l << 2;
    red = this.pixels[i];
    green = this.pixels[i + 1];
    blue = this.pixels[i + 2];
    ...
    node = this.root;
    _ref3 = this.depth;
    for (level = 1; (1 <= _ref3 ? level <= _ref3 : level >= _ref3); (1 <= _ref3 ? level += 1 : level -= 1)) {
...
Cube.prototype.assignment = function() {
  var _ref2, blue, green, i, id, l, len, node, pixel, red, search;
  this.colormap = [];
  this.colors = 0;
  this.root.colormap();
  search = new Search();
  ...
  for (l = 0; (0 <= _ref2 ? l <= _ref2 : l >= _ref2); (0 <= _ref2 ? l += 1 : l -= 1)) {
    ...
    this.pixels[i] = (pixel >> 16) & 0xFF;
    this.pixels[i + 1] = (pixel >> 8) & 0xFF;
    this.pixels[i + 2] = (pixel >> 0) & 0xFF;
  }
  return this;
};
Search = function() {
