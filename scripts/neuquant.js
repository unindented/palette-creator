(function() {
  ...
  NeuQuant.prototype.learn = function() {
    var a, alpha, alphadec, b, biasradius, delta, g, i, j, lengthcount, p, pos, r, rad, samplepixels, step;
    biasradius = this.initbiasradius;
    alphadec = 30 + Math.floor((this.sample - 1) / 3);
    lengthcount = this.pixels.length;
    ...
    while (i < samplepixels) {
      ...
      b = (p) & 0xff;
      if (i === 0) {
        this.network[this.bgcolor][0] = b;
        this.network[this.bgcolor][1] = g;
        this.network[this.bgcolor][2] = r;
      }
  ...
  NeuQuant.prototype.convertPixels = function(pixels) {
    ...
    for (l = 0; (0 <= _ref ? l < _ref : l > _ref); (0 <= _ref ? l += 1 : l -= 1)) {
      pixels[l] = this.convertPixel(pixels[l]);
    }
    return pixels;
  };
  ...
  NeuQuant.prototype.convertPixel = function(a, r, g, b) {
    var bb, gg, i, rr;
    i = this.search(b, g, r);
    bb = this.colormap[i][0];
    gg = this.colormap[i][1];
    rr = this.colormap[i][2];
